...
<body class="m-0 p-0 top-0 w-[100%] h-[100%] font-['Poppins'] bg-[#E4AE5C] ">
    <main class="flex justify-around items-center w-[100%] h-[100%]">
        <?php
            include './Menu.php';
        ?>
        <div class="flex flex-col justify-center items-center gap-8  w-[80%] h-[90%] bg-white rounded-lg ">
            <div class="flex justify-between items-center pr-4 pb-4 w-[90%]">
                <h1 class="text-4xl font-bold ">Ver Productos</h1>
                ...
                if ($resultado->num_rows > 0) {
                    ...
                    while ($fila = $resultado->fetch_assoc()) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td class=' text-base  border border-[#E4AE5C] text-center whitespace-normal'>" . $fila["descripcion"] . "</td>";
